...
// 1.3 - параметры
// 1.4 - тело функции
// 1.5 - return останавливает (завершает) выполнение функции
...
// ДЗ
// Написать функцию которая будет возвращать объект человека
// 1) Параметры функции должны быть имя и возраст человека
// 2) Возвращаемый объект должен уметь поздороваться с этим человекаом,
// вывести его возраст и сказать сколько человеку будет лет через 20 лет
